...
public class HouseholdController {
  ...
  public void initialize() {
    ...
    TableColumn<HoKhau, String> chuCol = Utils.createColumn("Chủ Hộ", "tenChuHo");
    chuCol.setMaxWidth(250);
    chuCol.setMinWidth(250);
    TableColumn<HoKhau, String> addrCol = Utils.createColumn("Địa chỉ", "diaChi");
    TableColumn<HoKhau, String> dateCol = Utils.createColumn("Ngày tạo", "ngayTaoString");
    dateCol.setMaxWidth(120);
    dateCol.setMinWidth(120);
    TableColumn<HoKhau, String> stateCol = Utils.createColumn("Trạng thái", "trangThai");
  ...
  public void openEdit(ActionEvent e) {
    ...
    TableColumn<NhanKhau, String> editNKNameCol = Utils.createColumn("Họ và tên", "hoTen");
    ...
    TableColumn<NhanKhau, String> editedNKNameCol = Utils.createColumn("Họ và tên", "hoTen");
  ...
  public void addNew(ActionEvent e) {
    ...
    TableColumn<NhanKhau, String> addNKNameCol = Utils.createColumn("Họ và tên", "hoTen");
    TableColumn<NhanKhau, String> addedNKIdCol = Utils.createColumn("Id", "ID");
    addedNKIdCol.setMinWidth(40);
    addedNKIdCol.setMaxWidth(40);
    TableColumn<NhanKhau, String> addedNKNameCol = Utils.createColumn("Họ và tên", "hoTen");
  ...
  public void openHistory(ActionEvent e) {
    ...
    TableColumn<ChuyenHoKhau, String> toCol = Utils.createColumn("Nơi chuyển đến", "noiChuyenDen");
    TableColumn<ChuyenHoKhau, String> noteCol = Utils.createColumn("Ghi chú", "ghiChu");
  ...
  private void openSplit() {
    ...
    TableColumn<NhanKhau, String> splitNKNameCol = Utils.createColumn("Họ và tên", "hoTen");
    ...
    TableColumn<NhanKhau, String> splitedNKNameCol = Utils.createColumn("Họ và tên", "hoTen");
